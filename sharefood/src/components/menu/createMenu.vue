<template>
  <div class="createMenu">
    ...
    <div class="jiange">
      ...
      <el-input v-model="menuname" placeholder="请输入菜谱名称" size="small" class="caipu-input"></el-input><br>
    </div>
    <!-- 成品图片 -->
      <div class="jiange">成品图片（最多3张）<span class="xing">*</span>:</div>
      <el-upload
    ...
    <div class="jiange"></div>
    <!-- 基本参数（难度、口味、工艺、耗时、厨具） -->
    <div class="jiange">基本参数<span class="xing">*</span>:<br></div>
    ...
    <!-- 食材明细 -->
    <div class="jiange">食材明细<span class="xing">*</span>:
    <el-button type="primary" size="mini" @click="dialogVisible1 = true">添加分组</el-button></div>
    ...
    <div v-for="(item1, index1) in groups" :key="index1" class="biankuang">
      ...
      <div v-for="(item2, index2) in item1.ingredient" :key="index2">
        <el-input v-model="item2.ingredientname" placeholder="食材名" size="small" class="shicaiming-input"></el-input>
    ...
    <!-- 做法步骤 -->
    <div class="jiange">做法步骤<span class="xing">*</span>:
    <el-button type="primary" size="mini" @click="addSteps()">添加步骤</el-button></div>
...
<div class="jiange"></div>
    ...
    <!-- 小窍门 -->
    <div class="jiange">小窍门<span class="xing">*</span>:<br></div>
    <el-input
        type="textarea"
        :rows="4"
...
<div class="youbian">
    <div class="jiange">原创<span class="xing">*</span>:<br></div>
  ...
  data() {
    ...
    methods: {
      ...
      addGroup(){     //添加食材组
        ...
        this.groups.push({groupname:this.shicaizuming,ingredient:[{ingredientname:'',amount:''}]})   //添加食材组名
        this.shicaizuming=''      //清空数据
      },
      delGroup(index1){    //删除食材组
        this.groups.splice(index1,1);
      },
      addIngredient(index1,index2){  //添加食材
        this.groups[index1].ingredient.splice(index2+1,0,{ingredientname:'',amount:''})
      },   
